...
function PlayerApp() {
  ...
  // No boot-time asset mirror (closure-prefetch design, 2026-07-21 round 2):
  // each surface ensures its own asset closure when opened — the daily
  // ensures its stamped closure before swapping in (Game.tsx), the Slab and
  // Training ensure the revealed set (usePlayerReveal), demo/arena boards
  // ensure per-puzzle on mount. Routes render immediately.
