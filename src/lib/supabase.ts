...
export interface DbAsset {
  id: string;
  type: 'tile_type' | 'enemy' | 'vessel' | 'ally' | 'character' | 'object' | 'skin' | 'spell' | 'status_effect' | 'folder' | 'collectible_type' | 'collectible' | 'hidden_assets' | 'sound' | 'global_sound_config' | 'global_haptic_config' | 'help_content' | 'theme_settings';
  name: string;
