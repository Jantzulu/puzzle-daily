            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {filteredSpells.map((spell) => (
                <button
                  ...
                  className="bg-gray-900 rounded-lg p-4 border-2 border-gray-700 hover:border-blue-500 transition-colors text-left"
                >
                  {/* Spell Header */}
                  <div className="flex items-start gap-3 mb-2">
                    {spell.thumbnailIcon ? (
                      <img
                        ...
                        alt={spell.name}
                        className="w-12 h-12 object-contain bg-gray-800 rounded border border-gray-600"
                      />
                    ) : (
                      <div className="w-12 h-12 bg-gray-800 rounded border border-gray-600 flex items-center justify-center text-gray-500 text-xs">
                        No Icon
                      </div>
                    )}
