...
export const PixelEditor = forwardRef<PixelEditorHandle, PixelEditorProps>(({
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps -- intentionally omits stable refs/callbacks to avoid excessive rebuilds
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps -- onMetadataChange intentionally excluded; changes too often and is not needed here
        ...
        {[...layersRef.current].reverse().map((layer, revIdx) => {
          ...
          return (
            ...
            >
              ...
              {isExpanded && (
                <div
                  className={`flex flex-col gap-1 px-2 py-1.5 text-xs border-t ${
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <div
                      className="flex-1 min-w-0 relative cursor-pointer select-none mx-1"
                      style={{ height: 16 }}
                      onPointerDown={(e) => {
                        e.stopPropagation();
                        e.preventDefault();
