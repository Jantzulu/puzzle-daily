        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex-1 flex flex-col items-center w-full overflow-visible">
              ...
              {/* Dev Tools - collapsible bar below board */}
              <div className="mt-2 w-full max-w-2xl px-3 md:px-4 py-1.5 dungeon-panel-dark rounded-pixel">
                <button
                ...
                {showDevTools && (
                  <div className="mt-1.5 space-y-1.5">
                    <div className="flex flex-wrap justify-center gap-2">
                      <button
                        onClick={handleStep}
                        className="dungeon-btn px-5 py-1.5 text-sm font-semibold"
                      ...
                      <button
                        onClick={handleReset}
                        className="dungeon-btn-danger px-5 py-1.5 text-sm font-semibold"
                      ...
                      {testMode === 'none' && gameState.gameStatus === 'running' && !isSimulating && (
                        <button
                          onClick={handlePlay}
                          className="dungeon-btn-success px-5 py-1.5 text-sm font-semibold"
                        >
                          Resume
                        </button>
                      )}
