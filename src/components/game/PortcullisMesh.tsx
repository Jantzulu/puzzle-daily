...
/* (THE CLOSED GATE'S TAIL — two iron rungs + bars extending 160px above
   the rail — lived here 2026-08-06 for the iOS 26 glass saga, and was
   REMOVED the same day: iOS never painted it (sticky-layer clip, by
   design), the mobile un-stick solved the hollow properly, and once the
   rail docked with the open menu the tail's rungs showed through the
   real beams' lattice gaps as doubled iron (user catch). Revert point:
   the commit before this removal.) */
