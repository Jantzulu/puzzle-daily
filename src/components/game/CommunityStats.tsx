...
export const CommunityStats: React.FC<CommunityStatsProps> = ({
  ...
  return (
    <details className="mt-3 text-left text-xs bg-stone-800/50 rounded-pixel p-2 border border-stone-700">
      <summary className="cursor-pointer text-copper-200 font-medieval text-sm font-medium">
