...
const MOVE_DURATION = 100; // Fast movement to minimize time visually on wrong tile
const IDLE_DURATION = 300; // More idle time on destination tile (where entity actually is)
