        ...
        <div className="flex flex-col gap-2">
          ...
          <div ref={gameBoardRef} className="flex-1 flex flex-col items-center w-full overflow-visible">
            ...
            {(gameState.gameStatus === 'setup' || gameState.gameStatus === 'running' || gameState.gameStatus === 'defeat' || testMode !== 'none') && (
              <div className="mb-2 w-full max-w-2xl px-3 md:px-4 py-1.5 dungeon-panel-dark -mt-[2px] relative z-10 overflow-visible rounded-bl-3xl rounded-br-3xl">
          ...
          <div className="w-full max-w-2xl mx-auto dungeon-panel p-1 lg:p-1.5 rounded-tl-3xl rounded-tr-3xl relative overflow-visible">
